...
class HeartDes:
    ...
    def secondpage1(self):
        ...
        def predict_heart_condition():
            try:
                ...
                if prediction[0] == 0:
                    ...
                    messagebox.showerror("Visit Doctor", "Your Heart Is At Great Risk !!!")
            except ValueError:
        ...
        tk.Label(self.root, text="Sex:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
        sex_entry = tk.Entry(self.root, width=30)
        sex_entry.pack(pady=5)

        tk.Label(self.root, text="Chest Pain Type:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
        cp_entry = tk.Entry(self.root, width=30)
        cp_entry.pack(pady=5)

        tk.Label(self.root, text="Resting Blood Pressure:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
        trestbps_entry = tk.Entry(self.root, width=30)
        trestbps_entry.pack(pady=5)

        tk.Label(self.root, text="Cholesterol:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
        chol_entry = tk.Entry(self.root, width=30)
        chol_entry.pack(pady=5)

        tk.Label(self.root, text="Fasting Blood Sugar:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
        fbs_entry = tk.Entry(self.root, width=30)
        fbs_entry.pack(pady=5)

        tk.Label(self.root, text="Resting Electrocardiographic Results:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
        ...
        tk.Label(self.root, text="Exercise Induced Angina:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
        ...
        tk.Label(self.root, text="Slope of the Peak Exercise ST Segment:", anchor="center", justify="center", bg="black", fg="white", font=("Arial", 14)).pack(pady=5)
